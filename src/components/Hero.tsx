...
const tabs = [
  { name: 'context-engineer.config.js', isActive: true },
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Advanced prompt engineering and AI development with systematic
                context management and prompts as code.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/docs/what-is-context-engineering">Get started</Button>
                <Button href="/docs/prompts-as-code" variant="secondary">
                  Learn More
                </Button>
              </div>
            </div>
